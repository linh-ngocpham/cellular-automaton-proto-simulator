...
/**
 * 
 * por lancer model2, il faudra activer cette partie 
 * 
 * 
 */
...
import javafx.util.Duration;
import model2.Board;
import model2.FirefighterBoard;
import model2.Movable;
import util.Position;
import view.Grid;
...
public class Controller {
  ...
  private void setModel(FirefighterBoard firefighterBoard) {
    this.board = requireNonNull(firefighterBoard, "firefighter.modelVirus is null");
  }
...
/*
  ...
  public void initialize(int squareWidth, int squareHeight, int columnCount, int rowCount,
                         int initialVirusCount, int initialDoctorCount,
                         int initialHospitalCount, int initialVaccinatedCount
                         ) {
    grid.setDimensions(columnCount, rowCount, squareWidth, squareHeight);
    this.setModel(new FirefighterBoard(columnCount, rowCount, initialVirusCount, initialDoctorCount,
            initialHospitalCount, initialVaccinatedCount));
    repaintGrid();
  }
...
/*
  public void initialize(int squareWidth, int squareHeight, int columnCount, int rowCount,
                         int hospitalCount, int initialVaccinatedCount,
                         int initialVirusCount) {
    grid.setDimensions(columnCount, rowCount, squareWidth, squareHeight);
    this.setModel(new FirefighterBoard(columnCount, rowCount, hospitalCount, initialVaccinatedCount,
                           initialVirusCount));
    repaintGrid();
  }
